...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "yPvHRndBsI7pfRAVv1TBWiPGQB7oEpsP";

	/*
	 * search function in TicketMasterAPI, which will actually send HTTP request and
	 * get response
	 */
	...
	/*
	 * a print function to show {
	 *     JSONObject returned from TicketMaster
	 *                      ↓
	 *                  Item List
	 *                      ↓
	 *               new JSON Objects      
	...
	private void queryAPI(double lat, double lon) {
		...
		try {
			for (Item item : itemList) {
				JSONObject itemToJSON = item.toJSONObject();
				System.out.println(itemToJSON);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
